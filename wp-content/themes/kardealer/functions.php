...
function kardealer_scripts()
{
    ...
    wp_enqueue_style('genericons', esc_url(get_template_directory_uri()) .
        '/genericons/genericons.css', array(), '3.4.1');
    // Theme stylesheet.
    wp_enqueue_style('kardealer-style', get_stylesheet_uri());
    // Load the Internet Explorer specific stylesheet.
    wp_enqueue_style('kardealer-ie', esc_url(get_template_directory_uri()) . '/css/ie.css',
        array('kardealer-style'), '20160816');
    wp_style_add_data('kardealer-ie', 'conditional', 'lt IE 10');
    // Load the Internet Explorer 8 specific stylesheet.
    wp_enqueue_style('kardealer-ie8', esc_url(get_template_directory_uri()) . '/css/ie8.css',
        array('kardealer-style'), '20160816');
    wp_style_add_data('kardealer-ie8', 'conditional', 'lt IE 9');
    // Load the Internet Explorer 7 specific stylesheet.
    wp_enqueue_style('kardealer-ie7', esc_url(get_template_directory_uri()) . '/css/ie7.css',
        array('kardealer-style'), '20160816');
    ...
    // Load the html5 shiv.
    wp_enqueue_script('kardealer-html5', esc_url(get_template_directory_uri()) .
        '/js/html5.js', array(), '3.7.3');
    wp_script_add_data('kardealer-html5', 'conditional', 'lt IE 9');
    wp_enqueue_script('kardealer-skip-link-focus-fix', esc_url(get_template_directory_uri()) .
    ...
    if (is_singular() && wp_attachment_is_image()) {
        wp_enqueue_script('kardealer-keyboard-image-navigation',
            esc_url(get_template_directory_uri()) . '/js/keyboard-image-navigation.js', array('jquery'),
            '20160816');
    }
    ...
    if ($kardealer_header_style == '1') {
        wp_enqueue_script('kardealer-script', esc_url(get_template_directory_uri()) .
    ...
    if ($kardealer_header_style == '1') {
        wp_enqueue_style('kardealer-header1', esc_url(get_template_directory_uri()) .
    ...
    if (get_theme_mod('kardealer_preloader', '1') == '1') {
        wp_register_script('preloading', esc_url(get_template_directory_uri()) .
    ...
    if ($kardealer_blog_style == '3')
        wp_enqueue_script('kardealer-masonry', esc_url(get_template_directory_uri()) .
...
if (is_admin()) {
    ...
    */
    ...
    function kardealer_memory_notice()
    {
        ...
        echo '<img width="100px" src="' . esc_url(get_template_directory_uri()) .
            '/images/lock.png" />';
...
function boatseller_gutenberg_editor_styles() {
	wp_enqueue_style( 'boatseller_gutenberg-editor-style', esc_url(get_template_directory_uri()) . '/css/gutenberg-editor-style.css' );
