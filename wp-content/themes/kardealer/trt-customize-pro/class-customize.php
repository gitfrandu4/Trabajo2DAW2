 ...
 * @access public
 */
final class kardealer_Customize {
	...
	//	$manager->register_section_type( 'control-section-kardealer' );
		...
		$manager->add_section(
			new kardealer_Customize_Section_Pro(
				...
				array(
					...
					'pro_url'  => 'http://kardealertheme.com/help/index.php'
				)
			)
		);
  		// Register custom section types.
		...
		$manager->add_section(
			new kardealer_Customize_Section_Pro(
				...
				array(
					...
					'pro_text' => esc_html__( 'Go',         'kardealer' ),
					'pro_url'  => 'http://siterightaway.net/kar-dealer-premium-theme/'
				)
			)
		);
	}
	...
	public function enqueue_control_scripts() {
		...
		//wp_register_style( 'kardealer-customize-controls-style', trailingslashit( get_template_directory_uri() ) . 'trt-customize-pro/customize-controls.css' , array(), '', true );
      //  wp_enqueue_style( 'kardealer-customize-controls-style');
...
kardealer_Customize::get_instance();
