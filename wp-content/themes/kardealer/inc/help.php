...
function kardealer_enqueue_scripts() {
        ...
        wp_register_script( 'kardealer-fix-config-manager',kardealerURL.'/js/fix-config-manager.js' , array( 'jquery' ), kardealerVERSION, true );
    	wp_enqueue_script( 'kardealer-fix-config-manager' );
...
<div id = "kardealer-theme-help-wrapper">   
     ...
     <div id="kardealer-logo">
       <img  alt="aux" id="kardealer-logo-image" src="<?php echo esc_url(get_template_directory_uri())?>/images/logo.png" />
     </div>
