   ...
   <div id="kardealer-steps3">
    ...
    <div class="kardealer-help-container1">
       ...
       <div class="kardealer-help-column kardealer-help-column-3">
            ...
            <br /><br />   
            <a href="<?php echo esc_url(home_url())?>/wp-admin/customize.php?return=%2Fwp-admin%2Findex.php" class="button button-primary">Theme Management</a>
        </div> <!-- "Column 3">  --> 
    </div> <!-- "Container 1 " -->    
   ...
   <div id="kardealer-services3">
    ...
    <div class="kardealer-help-container1">
        ...
        <div class="kardealer-help-column kardealer-help-column-2">
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;
                  <a href="<?php echo $site;?>/premium" style="background:red" class="button button-primary">Upgrade to Premium</a>
        </div> <!-- "columns 2">  --> 
       <div class="kardealer-help-column kardealer-help-column-3">
