          ...
          <div class="row marremove">
            ...
            <div class="top-contact col-lg-4 col-md-4">
              <span class="call"><i class="<?php echo esc_attr(get_theme_mod('vw_automobile_lite_phone_icon','fa fa-phone')); ?>"></i>
                <a href="tel:<?php echo esc_url( get_theme_mod('vw_automobile_lite_contact','') ); ?>"><?php echo esc_html(get_theme_mod('vw_automobile_lite_contact',''));?></a></span>
            </div>
            <?php } if(get_theme_mod('vw_automobile_lite_email') != '') { ?>  
            <div class="top-contact col-lg-4 col-md-4">   
              <span class="email"><i class="<?php echo esc_attr(get_theme_mod('vw_automobile_lite_cont_email_icon','fas fa-envelope')); ?>"></i><a href="mailto:<?php echo esc_html(get_theme_mod('vw_automobile_lite_email',''));?>"><?php echo esc_html(get_theme_mod('vw_automobile_lite_email',''));?></a></span>
            </div>
