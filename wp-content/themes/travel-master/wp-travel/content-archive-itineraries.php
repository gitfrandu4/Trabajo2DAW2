...
if ( post_password_required() ) {
	...
	$enable_sale 	= travel_master_wptravel_is_enable_sale( get_the_ID() ); 
	$group_size 	= travel_master_wptravel_get_group_size( get_the_ID() );
	$start_date 	= get_post_meta( get_the_ID(), 'wp_travel_start_date', true );
	$end_date 		= get_post_meta( get_the_ID(), 'wp_travel_end_date', true ); ?>
	<?php $view_mode = travel_master_wptravel_get_archive_view_mode(); ?>
	<?php if ( 'list' === $view_mode ) : ?>
		<article class="wp-travel-default-article">
			<div class="wp-travel-article-image-wrap">
				<a href="<?php the_permalink(); ?>">
					<?php echo travel_master_wptravel_get_post_thumbnail( get_the_ID(), 'post-thumbnail' ); ?>
				</a>
				<?php if ( travel_master_wptravel_tab_show_in_menu( 'reviews' ) ) : ?>
					<?php travel_master_wptravel_trip_rating( get_the_ID() ); ?>
					<?php $count = (int) travel_master_wptravel_get_review_count(); ?>
			...
			<div class="wp-travel-entry-content-wrapper">
				<div class="description-left">
					...
					<?php travel_master_wptravel_do_deprecated_action( 'wp_tarvel_before_archive_title', array( get_the_ID() ), '2.0.4', 'wp_travel_before_archive_content_title' ); ?>
				...
				<div class="description-right">
					<?php travel_master_wptravel_trip_price( get_the_ID() ); ?>

					<div class="travel-info">
						<span><?php esc_html_e( 'Duration:', 'travel-master' ); ?></span>
						<?php travel_master_wptravel_get_trip_duration( get_the_ID() ); ?>
					</div>
	...
	<?php else : ?>
		<?php travel_master_wptravel_get_template_part( 'shortcode/itinerary', 'item' ); ?>
	<?php endif; ?>
